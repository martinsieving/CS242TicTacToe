...
# build test package
os.system('javac -d ' + dir + ' ../src/test/EventTest.java ../src/test/RequestTest.java ../src/test/ResponseTest.java ../src/test/SocketServerTest.java ../src/test/UserTest.java')

# build main
os.system('javac -d ' + dir + ' ../src/Main.java')
